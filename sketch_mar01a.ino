...
#define PASSWORD "1t3s0IoT18" // WIFI pwd
#define TOKEN "BBFF-p7zAoGwCrnSgZ4Ts8Mn4gcsQYuqCUN" // Ubidots TOKEN name el mismo que usamos en clase
#define MQTT_CLIENT_NAME "123456AbCde" //ID del cliente, 8 a 12 chars alfanumericos
